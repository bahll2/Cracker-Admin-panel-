...
#----------------------------------------
#| Code => General of Palestine       		|
#| Fb => bahaa said               |
#| Mail => bahaa333@outlook.sa   |
#| From = > Palestine                      |
...
def start(h):
		for s in h + '\n':
		    ...
		    stdout.flush()
		    sleep(10. /90)
start('\t\t\t~ ... Extract Control Panel ... ~ '.title())
sleep(3)
red ='\033[1;91m'
green ='\033[1;32m'
white ='\033[94m'
...
print('\033[94mPlease put / at the end of the link to work with you in the correct format.')

url=input('\033[1;32mEnter the link with [http/s] : ')

print ('Checking please wait ...')

admin=['admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for lists in admin :
		  ...
		  try :
		      ...
		      print ('\033[94m[+] Found --> ' '[ '+curl+' ]')
		  except urllib.error.URLError as msg:
		    print ('\033[1;91m[-] Not found [ '+curl+' ]')
start()
